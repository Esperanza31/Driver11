...
class Afternoon_Page extends StatefulWidget {
  const Afternoon_Page({super.key});

  @override
  State<Afternoon_Page> createState() => _Afternoon_PageState();
}

class _Afternoon_PageState extends State<Afternoon_Page> with WidgetsBindingObserver{
